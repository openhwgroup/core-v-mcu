...
set_property -dict { PACKAGE_PIN R19 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[6] }]; #IO_0_14 Sch=cpu_resetn
...
## Switches
set_property -dict { PACKAGE_PIN G19 IOSTANDARD LVCMOS12 } [get_ports { xilinx_io[4] }]; #IO_0_17 Sch=sw[0]
set_property -dict { PACKAGE_PIN G25 IOSTANDARD LVCMOS12 } [get_ports { xilinx_io[45] }]; #IO_25_16 Sch=sw[1]
...
## UART
set_property -dict { PACKAGE_PIN Y23 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[8] }]; #IO_L1P_T0_12 Sch=uart_rx_out
set_property -dict { PACKAGE_PIN Y20 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[7] }]; #IO_0_12 Sch=uart_tx_in
...
#set_property -dict { PACKAGE_PIN T22   IOSTANDARD LVCMOS33 } [get_ports { ja[7] }]; #IO_L5P_T0_D06_14 Sch=ja_p[3]
set_property -dict { PACKAGE_PIN T23 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[9] }]; #IO_L5N_T0_D07_14 Sch=ja_n[3]
set_property -dict { PACKAGE_PIN T20 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[10] }]; #IO_L4P_T0_D04_14 Sch=ja_p[4]
set_property -dict { PACKAGE_PIN T21 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[12] }]; #IO_L4N_T0_D05_14 Sch=ja_n[4]

## PMOD Header JB
set_property -dict { PACKAGE_PIN V29 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[37] }]; #IO_L17P_T2_A14_D30_14 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN V30 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[38] }]; #IO_L17N_T2_A13_D29_14 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN V25 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[39] }]; #IO_L18P_T2_A12_D28_14 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN W26 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[40] }]; #IO_L18N_T2_A11_D27_14 Sch=jb_n[2]
set_property -dict { PACKAGE_PIN T25 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[41] }]; #IO_L14P_T2_SRCC_14 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN U25 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[42] }]; #IO_L14N_T2_SRCC_14 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN U22 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[43] }]; #IO_L21P_T3_DQS_14 Sch=jb_p[4]
...
set_property -dict { PACKAGE_PIN AD26 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[25] }]; #IO_L19N_T3_VREF_13 Sch=jc[7]
set_property -dict { PACKAGE_PIN AG30 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[26] }]; #IO_L18P_T2_13 Sch=jc[8]
set_property -dict { PACKAGE_PIN AK30 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[27] }]; #IO_L15N_T2_DQS_13 Sch=jc[9]
...
set_property -dict { PACKAGE_PIN U24 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[33] }]; #IO_L23P_T3_A03_D19_14 Sch=jd[7]
set_property -dict { PACKAGE_PIN Y26 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[34] }]; #IO_L1P_T0_13 Sch=jd[8]
set_property -dict { PACKAGE_PIN V22 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[35] }]; #IO_L22N_T3_A04_D20_14 Sch=jd[9]
set_property -dict { PACKAGE_PIN W21 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[36] }]; #IO_L24P_T3_A01_D17_14 Sch=jd[10]

## XADC Header
set_property -dict { PACKAGE_PIN J24 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[17] }]; #IO_L1N_T0_AD0N_15 Sch=xadc0r_n
set_property -dict { PACKAGE_PIN J23 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[13] }]; #IO_L1P_T0_AD0P_15 Sch=xadc0r_p
set_property -dict { PACKAGE_PIN K24 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[18] }]; #IO_L3N_T0_DQS_AD1N_15 Sch=xadc1r_n
set_property -dict { PACKAGE_PIN K23 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[14] }]; #IO_L3P_T0_DQS_AD1P_15 Sch=xadc1r_p
set_property -dict { PACKAGE_PIN L23 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[19] }]; #IO_L2N_T0_AD8N_15 Sch=xadc8r_n
set_property -dict { PACKAGE_PIN L22 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[15] }]; #IO_L2P_T0_AD8P_15 Sch=xadc8r_p
set_property -dict { PACKAGE_PIN K21 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[20] }]; #IO_L4N_T0_AD9N_15 Sch=xadc9r_n
set_property -dict { PACKAGE_PIN L21 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[16] }]; #IO_L4P_T0_AD9P_15 Sch=xadc9r_p
...
## IIC Bus
set_property -dict { PACKAGE_PIN AE30 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[46] }]; #IO_L16P_T2_13 Sch=sys_scl
set_property -dict { PACKAGE_PIN AF30 IOSTANDARD LVCMOS33 } [get_ports { xilinx_io[47] }]; #IO_L16N_T2_13 Sch=sys_sda
