...
^^^^^^^^^^^^^^^^^^^^^^^
  ...
  - start_rto_i: Start ready timeout input, triggers the ready timeout counter. 
  - peripheral_rto_i[10:0]: Peripheral ready timeout input, indicates which peripheral caused the timeout.
