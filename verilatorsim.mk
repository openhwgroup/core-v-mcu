...
CPP := gcc
CXX := g++
CPPFLAGS := -I$(VINCDIR) -I$(VINCDIR_DPI) -I./obj_dir -I../../../tb/uartdpi/ -DVL_TIME_CONTEXT -DVM_COVERAGE=0 -DVM_SC=0 -DVM_TRACE=1 -DVM_TRACE_FST=1 -Wno-bool-operation -Wno-sign-compare -Wno-uninitialized -Wno-unused-but-set-variable -Wno-unused-parameter -Wno-unused-variable -Wno-shadow -Wall
CXXFLAGS := -std=c++11 -g -fpermissive  -std=gnu++14 -O0 -g3
LDFLAGS := -lz -pthread -lutil
...
core_v_mcu_tb.exe: $(OBJS) verilated.o verilated_dpi.o verilated_fst_c.o uartdpi.o $(MODEL_LIB)
	echo $(VBINDIR)
	$(CXX) $^ $(LDFLAGS) $(USER_LDFLAGS) -o $@

verilated.o: $(VERILATED_SRC) $(VERILATED_DEPS) $(MODEL_LIB)
	$(CXX) $(CPPFLAGS) $(USER_CPPFLAGS) $(CXXFLAGS) $(USER_CXXFLAGS) -c -o $@ $(VERILATED_SRC)

verilated_dpi.o: $(VERILATED_DPI_SRC) $(VERILATED_DEPS) $(MODEL_LIB)
	$(CXX) $(CPPFLAGS) $(USER_CPPFLAGS) $(CXXFLAGS) $(USER_CXXFLAGS) -c -o $@ $(VERILATED_DPI_SRC)

verilated_fst_c.o: $(VERILATED_FST_C_SRC) $(VERILATED_FST_C_DEPS) $(MODEL_LIB)
	$(CXX) $(CPPFLAGS) $(USER_CPPFLAGS) $(CXXFLAGS) $(USER_CXXFLAGS) -c -o $@ $(VERILATED_FST_C_SRC)

mem_init:
	$(RM) $@
	ln -s ./mem_init $@
uartdpi.o: ../../../tb/uartdpi/uartdpi.c
	$(CXX) $(CPPFLAGS) $(USER_CPPFLAGS) $(CXXFLAGS) $(USER_CXXFLAGS)  -c -o $@ $<
