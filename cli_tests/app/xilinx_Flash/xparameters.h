...
extern unsigned char gCheatAddressSpace[];
...
#define XPAR_XQSPIPS_0_BASEADDR 	(unsigned int)( &gCheatAddressSpace )//0x1C07F000	//0xE000D000	//Somesh: Pointing it to a known area so that minimal changes are need for porting
#define XPAR_XQSPIPS_0_HIGHADDR 	(unsigned int)( (&gCheatAddressSpace) + 256 )//0x1C07FFFF	//0xE000DFFF
