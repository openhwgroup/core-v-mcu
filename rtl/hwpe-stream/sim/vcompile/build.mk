...
ifndef VERBOSE
	LIB_CREATE=@vlib
	LIB_MAP=@vmap
	SVLOG_LINT=@verilator -DSYNTHESIS -sv --lint-only
	SVLOG_CC=@vlog -quiet -sv
	VLOG_LINT=@verilator -DSYNTHESIS --lint-only
	VLOG_CC=@vlog -quiet
	VHDL_CC=@vcom -quiet
	...
	LIB_CREATE=vlib
	LIB_MAP=vmap
	SVLOG_LINT=@verilator -sv --lint-only -Wall
	SVLOG_CC=vlog -quiet -sv
	VLOG_LINT=@verilator --lint-only
	VLOG_CC=vlog -quiet
	VHDL_CC=vcom -quiet
